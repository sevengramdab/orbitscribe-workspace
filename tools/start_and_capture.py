#!/usr/bin/env python3
"""Close devtools, click Initialize Engine, wait for fluid, and capture a screenshot."""
import sys
import os
import time
...
def main():
    ...
    # Click "Initialize Engine" button (bottom center of window)
    cx = win.left + win.width // 2
    cy = win.top + int(win.height * 0.93)
    pyautogui.click(cx, cy)
    print(f"Clicked Initialize Engine at ({cx}, {cy})")
    time.sleep(0.5)
