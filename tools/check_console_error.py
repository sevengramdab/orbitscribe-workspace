#!/usr/bin/env python3
"""Switch to Console tab via keyboard and screenshot to see errors."""
import sys
import os
import time
...
OUTPUT_PATH = sys.argv[1] if len(sys.argv) > 1 else os.path.join(
    os.path.dirname(__file__), "..", "screenshots", "jukebox_console_error.png"
)
...
def main():
    ...
    # Focus devtools and switch to Console tab using Ctrl+]
    # First click inside devtools panel to focus it
