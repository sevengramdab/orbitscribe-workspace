#!/usr/bin/env python3
"""Simulate button click via JS console and screenshot."""
import sys
import os
import time
...
OUTPUT_PATH = sys.argv[1] if len(sys.argv) > 1 else os.path.join(
    os.path.dirname(__file__), "..", "screenshots", "jukebox_js_click.png"
)
...
def main():
    ...
    # Ensure console is open with Ctrl+Shift+J
    ...
    # Simulate button click via JS
    type_in_console("document.getElementById('btn-start').click()")
