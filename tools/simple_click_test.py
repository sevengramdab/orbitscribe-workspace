#!/usr/bin/env python3
"""Simple test: click Initialize Engine button and screenshot."""
import sys
import os
import time
...
OUTPUT_PATH = sys.argv[1] if len(sys.argv) > 1 else os.path.join(
    os.path.dirname(__file__), "..", "screenshots", "jukebox_simple_click.png"
)
...
def main():
    ...
    # Click the Initialize Engine button (calibrated for 1696x1018 window)
