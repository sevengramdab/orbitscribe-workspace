...
# Default workspace root — dedicated directory so swarm never writes to extension install dir
_default_workspace = os.path.join(os.path.expanduser("~"), "OrbitScribe")
