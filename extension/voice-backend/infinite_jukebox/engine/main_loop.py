...
# Like commissioning five separate electrical rooms with their own breaker panels and VFDs.
...
class InfiniteJukeboxEngine:
    ...
    def __init__(self, config: EngineConfig = None) -> None:
        ...
        self.model = ModelSpace(
            ...
            # Like mounting five monitors on the security wall and wiring each to its own GPU panel.
            viewports=[
                ViewportConfig(slot=ViewportSlot(i), gpu_index=i % 5)
                for i in range(self.cfg.max_viewports)
            ],
        )
        ...
        # --- GPU / VIEWPORTS (the five RTX 5090 electrical rooms) ---
        # Like hiring the master electrician to wire five separate service panels.
        ...
        # Like walking onto the jobsite with a thermal camera and a clamp meter to read five breaker panels.
        self.hw_profiler = HardwareProfiler(gpu_count=5)
    ...
    def get_performance_report(self) -> Dict[str, Any]:
        ...
        # Like walking down the hallway and pointing the thermal camera at each of the five breaker panels.
