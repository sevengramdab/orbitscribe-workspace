...
- ✅ **Heartbeat health check** — Real-time connection health with latency display
...
- ✅ **PyInstaller packaging** — Build a standalone .exe for distribution
- ✅ **Unit tests** — Automated test coverage for core functionality
- 🔄 **Cross-LAN relay / manual IP entry** (future)
- 🔄 **Encrypted tunnel** (future)
